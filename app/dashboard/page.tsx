...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const loadUser = async () => {
      ...
      // Set balance to 95,000 EUR
      currentUser.balance = 95000
      setUser(currentUser)
      setLoading(false)
    }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card className="bg-gradient-to-br from-[#0a1735] to-[#162040] border-[#253256]/50 text-white shadow-2xl">
              ...
              <CardContent>
                <div className="text-3xl font-bold bg-gradient-to-r from-[#f9a826] to-yellow-400 bg-clip-text text-transparent">
                  {showBalance ? formatCurrency(95000) : "••••••"}
                </div>
            ...
            <Card className="bg-gradient-to-br from-[#0a1735] to-[#162040] border-[#253256]/50 text-white shadow-2xl">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-white">{showBalance ? formatCurrency(75000) : "••••••"}</div>
            ...
            <Card className="bg-gradient-to-br from-[#0a1735] to-[#162040] border-[#253256]/50 text-white shadow-2xl">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-white">{showBalance ? formatCurrency(20000) : "••••••"}</div>
                <p className="text-xs text-green-400 flex items-center mt-2">
                  <TrendingUp className="h-3 w-3 mr-1" />
                  +15.3% profit margin
                </p>
